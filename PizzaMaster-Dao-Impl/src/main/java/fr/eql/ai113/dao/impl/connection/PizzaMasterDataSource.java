package fr.eql.ai113.dao.impl.connection;
...
public class PizzaMasterDataSource implements DataSource {

    private final static Logger logger = LogManager.getLogger();


    private static final String DATABASE_PROPERTY_FILE_PATH = "pizzamaster_db.properties";
